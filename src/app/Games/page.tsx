...
import { ArrowBigDown, ArrowBigLeft, ArrowBigRight, ArrowBigUp, ArrowLeftCircle } from 'lucide-react';
...
export default function EmulatorPage() {
  ...
  return (
    <div className='h-screen bg-linear-to-r from-cyan-400 via-blue-400 to-indigo-400' style={{
      color: '#fff',
     ...
     */}
      <div id="game-container" style={{ height: '480px', maxWidth: '100%', margin: '0 auto' }}>
        <div id="game" style={{ height: '100%' }}></div>
      </div>
      <div className="mt-6 p-4 flex justify-center items-center flex-col rounded-lg">
        <h3 className="text-lg  py-4 text-left font-extrabold text-[#ffffff] mb-3">
          Keyboard Controls
        </h3>
        <div className="flex justify-items-center flex-col gap-4">
          <div>
          ...
          <div>
            <button
              ...
              className="fixed top-6 left-6 z-50 px-6 py-2 rounded bg-transparent text-white font-bold  hover:scale-105 transition-transform duration-150"
            >
              <ArrowLeftCircle />
            </button>
          </div>
