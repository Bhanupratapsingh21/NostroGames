    ...
    return (
        <div className="w-full bg-gradient-to-br from-gray-900 via-purple-900 to-gray-800 px-14 sm:px-6 lg:px-8 py-24 relative">
            ...
            <div className="flex justify-center mt-12">
                <Link
                    href="/BYOG"
                    className="text-lg font-semibold text-cyan-400 hover:text-cyan-300 underline underline-offset-4 transition-colors"
                >
                    Don&apos;t have your fav game here? <span className="text-pink-500 font-bold">Bring Your OWN GAME</span>
                </Link>
            </div>
        </div>
    );
